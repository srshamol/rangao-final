...
interface Props {
  ...
  desktopCols?: number;
  productIds?: string[];
  filter?: "best_seller" | "manual";
}

const BestSellers = ({
  title = "আমাদের বেস্ট সেলার কালেকশন",
  subtitle = "আমাদের সবচেয়ে জনপ্রিয় এবং সবচেয়ে বেশি বিক্রি হওয়া কাস্টমাইজড সামগ্রী",
  count = 4,
  desktopCols = 4,
  productIds,
  filter = "best_seller",
  ...
  const { data: products, isLoading } = useProducts({
    filter: filter === "manual" && productIds?.length ? "manual" : "best_seller",
    limit: count,
    ids: productIds,
  });
